                        ...
                        <>
                            ...
                            {node.leftId &&
                                <Leaf
                                    ...
                                    position={{ x: Math.min(-nodeOffset / 10, determineOffset()) - 25 + level * 10, y: 10 + Math.max(nodeOffset / 10, -4) }}
                            ...
                            {node.rightId &&
                                <Leaf
                                    id={node.rightId}
                                    position={{ x: Math.max(nodeOffset / 10, -determineOffset()) + 25 - level * 10, y: 10 + Math.max(nodeOffset / 10, -4) }}
